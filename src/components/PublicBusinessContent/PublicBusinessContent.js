...
import './PublicBusinessContent.less';

const PublicBusinessContent = React.createClass({
    /**
    ...
    render () {
        return (
            <div id="content" className="p-businesscontent content">
                <div className="panel panel-success" data-sortable-id="form-wysiwyg-2">
                    <div className="panel-heading">
                        <h4 className="panel-title">政府招商</h4>
                    </div>
                    <div className="panel-body">
                        ...
                        <form className="form-horizontal">
                            ...
                            <div className="form-group">
                                <label className="col-md-3 control-label">招商行业</label>
                                <div className="col-md-9">
                            ...
                            <div className="form-group">
                                <label className="col-md-3 control-label">投资估算</label>
                                <div className="col-md-9">
                                    <input type="text" className="form-control" placeholder="" />
                                </div>
                            </div>
                            <div className="form-group">
                                <label className="col-md-3 control-label">招商方式</label>
                                <div className="col-md-9">
                            ...
                            <div className="form-group has-feedback">
                                <label className="col-md-3 control-label">项目内容</label>
                                <div className="col-md-9">
                                    <textarea className="form-control" placeholder="" rows="5"></textarea>
                                </div>
                            </div>
                            <div className="form-group has-feedback">
                                <label className="col-md-3 control-label">投资环境</label>
                                <div className="col-md-9">
                                    <textarea className="form-control" placeholder="" rows="5"></textarea>
                                </div>
                            </div>
                            ...
                            <div className="form-group">
                                <label className="col-md-3 control-label">项目背景</label>
                                <div className="col-md-9">
                                    <input type="text" className="form-control" placeholder="" />
                                </div>
                            </div>
                            <div className="form-group has-feedback">
                                <label className="col-md-3 control-label">项目规模</label>
                                <div className="col-md-9">
                                    <textarea className="form-control" placeholder="" rows="5"></textarea>
                                </div>
                            </div>
                            ...
                            <div className="form-group">
                                <label className="col-md-3 control-label">效益预算</label>
                                <div className="col-md-9">
                                    <input type="text" className="form-control" placeholder="" />
                                </div>
                            </div>
                            <div className="form-group has-feedback">
                                <label className="col-md-3 control-label">优惠政策</label>
                                <div className="col-md-9">
                                    <textarea className="form-control" placeholder="" rows="5"></textarea>
                                </div>
                            </div>
...
export default PublicBusinessContent;