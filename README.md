...
|   |   ├── /PublicApp/                     # 主页模块
|   |   ├── /PublicContainer/               # 主页模块
|   |   ├── /PublicContent/                 # 主页模块
|   │   ├── /PublicCommonHeader             # 通用模块 -- Header
|   │   ├── /PublicCommonSidebar            # 通用模块 -- 菜单栏模块
|   │   ├── /PublicCommonSidebarItem        # 通用模块 -- 菜单项模块
|   │   ├── /PublicCommonSidebarItemSub     # 通用模块 -- 二级菜单项模块
